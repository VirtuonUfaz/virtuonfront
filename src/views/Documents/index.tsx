                ...
                <div className="border rounded flex-1 flex-as-s">
                    ...
                    <div className="flex flex-column  px-14" >
                        ...
                        <div className="flex py-1">
                            ...
                            <p className=" ml-4 text">Registration cancellation Certificate</p>
                        </div>
                        ...
                        <div className="flex py-1">
                            ...
                            <p className=" ml-4 text">Payment certificate and account situation</p>
                        </div>
                    ...
                    <div className="flex py-4 px-8 ml-5">
                        ...
                        <input type="submit" className="submit-button ml-4 " value="Okay" onClick={()=> setPrint(select_value)}/>
                    </div>

                    <div className="text-md px-8 py-4 pt-10">You have selected:</div>

                    <div className="px-14 py-2 pb-10">
                        <div className="sm-header py-4 italic">{docType} - {print_value}</div>
                        <div>
                            <input type="submit" className={`confirm-button bg-${hasAccess ? 'green' : 'light-gray'}`} value="To confirm"/>
                            <input type="submit" className="cancel-button ml-4" value="To cancel"/>
                        </div>
                        {hasAccess ? "" : <div className="text-sm py-4">You have no access to this file, you can request access to this file</div>}
                    </div>
