    ...
    <section id="journal">
      <div className="container">
        <div className="jtitle mt-5">
          <h3>
            Titration of hydrochloric acid solution by sodium hydroxide solution
          </h3>
        </div>
        <div className="sjimg">
          <img
        ...
        <div className="jauthors">
          ...
          <a href="blogProfile">Ibrahimkhanli Murad</a>
        </div>
        <div className="jdate">
        ...
        <div className="jdescription">
          ...
          <p>
            ...
            concentration (in our case NaOH) and to detect the equivalence point
            with the help of the the pH-meter, at which the moles of base are
            equal to the moles of acid.
          </p>
        </div>
        <div className="jdownload">
          <span style={{ color: "red" }} className="download">
            Download (only users): <a href="#">[PDF] from bookufaz.com</a>
          </span>
        </div>
        <div className="jreferences mt-5">
          <span className="info">References</span>
          <br />
          1. Safety:
          https://www.msdsonline.com/2014/09/10/hydrochloric-acid-hazards-safety-tips/
          <br />
          2. Procedure: Austin Peay State University Department of Chemistry,
          Chem 1011
          <br />
          3. Khan Academy. Acid-Base titration curves. Available from:
          ...
          <br />
          4.Titration: Acid-Base Crime Scene Titration, Angelica Rodriguez,
          Period 4, 05/14/13
          <br />
